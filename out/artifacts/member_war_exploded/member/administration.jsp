    ...
    <div id="center" class="center">
        <div class="one">
            <table border="1" class="search-key">
                <tr >
                    <th rowspan="3" class="opt_hint">上传账号 一码一号</th>
            ...
            <table border="1" class="search-key">
            <tr>
                <th rowspan="3" class="opt_hint">查提取码 一码一号</th>
        ...
        <div class="more">
            <table border="1" class="search-key">
                <tr >
                    <th rowspan="3" class="opt_hint">上传账号 一码多号</th>
                    <td >会员类型<select name="type" id="more-type"/>
                        <option value="1" selected>爱奇艺会员</option>
                        <option value="2">土豆会员</option>
                        <option value="3" >迅雷会员</option>
                        <option value="4">乐视会员</option>
                ...
                <tr>
                    <td>
                    <textarea rows="10" cols="40" id="more-account" class="textarea">
                ...
                <tr>
                    <td>
                        <a class="save"  name="btn-get-code" onclick = "SaveAccountMore()">上传</a>
                    </td>
                </tr>
            </table>
            <table border="1" class="search-key">
                <tr >
                    <th rowspan="3" class="">更新领取码</th>
                    <td >会员类型<select name="type" id="update-type"/>
                        <option value="1" selected>爱奇艺会员</option>
                        <option value="2">土豆会员</option>
                        <option value="3" >迅雷会员</option>
                        <option value="4">乐视会员</option>
                ...
                <tr>
                    <td>
                    <input  id="update-key" class="input">
                    </input>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a class="save"  name="btn-get-code" onclick = "UpdateKeyMore()">更新</a>
                    </td>
                </tr>
            </table>
